...
if (isset($_POST['submit'])) {
  ...
  $data = runRawSql1($query);
  $total = mysqli_num_rows($data);

  if ($total > 0) {
    $_SESSION['nicename'] = $nicename;
    header('location: dashboard-messages-detail.php?msg=ok');
    exit();
  } else {
    echo header('location: login2.php?msg=not-ok');
    exit;
  }
}
?>
              ...
              <form action="login2.php" method="POST">
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="text" name="nicename" class="form-control input-lg" id="nicename" aria-describedby="emailHelp" placeholder="nicename">
                  </div>
