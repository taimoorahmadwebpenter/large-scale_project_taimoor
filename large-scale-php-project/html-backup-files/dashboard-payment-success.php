                                ...
                                <div class="block">
                                    <div class="block-head">
                                        <div class="block-left">
                                            <h2 class="title">Thank you! We've received your payment.</h2>
                                        </div><!-- block-left -->
                                    </div><!-- block-head -->

                                    <div class="block-body">
                                        <p><strong>Below your order information:</strong></p>
                                        <div class="payment-list">
                                            <ul>
                                                <li>Payment method: <span>PayPal</span></li>
                                                <li>Total: <span>$25.00</span></li>
                                            </ul>
                                        </div><!-- payment-list --> 
                                    </div>
                                </div><!-- .block -->
