...
<body>
    ...
    <div class="nav-area header-type-1">
        <header class="header-wrap">
            <div class="header-search">
                <div class="container">
                    <div class="header-inner table-block">
                        <div class="header-comp-menu">
                            <?php include ('inc/header/side-menu.php'); ?>
                        </div>
                        <div class="header-comp-logo">
                            <?php include ('inc/header/logo.php'); ?>
                        </div>
                        <div class="header-comp-search">
                            <?php include ('inc/header/search.php'); ?>
                            <div class="search-daypicker-expanded">
                                <div class="daypicker-area"></div>
                                <div class="selection-area">
                                    ...
                                    <div class="search-types">
                                        ...
                                        <label class="control control--checkbox">
                                            <input name="air-conditioning" type="checkbox">
                                    ...
                                    <button class="btn btn-primary">Find a Place</button>
                                </div>
                            </div>
                        </div>
            ...
            <?php include ('inc/header/extended-menu.php'); ?>
        </header>
    </div>
            ...
            <div class="header-nav">
                <div class="container">
                    <div class="header-inner table-block">
                        ...
                        <div class="header-comp-right">
                            <?php include ('inc/header/currency-language-switcher.php'); ?>
                        </div>
                    </div>
                </div>
            </div>
