<div class="search-filter">
	...
	<div class="search-filter-wrap">
		...
		<div class="filters-wrap">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
					...
					<div class="collapse" id="collapseNeightborhoods">
						<div class="filters">
							<label class="control control--checkbox">
								<input name="Option Name" type="checkbox">
								<span class="contro-text">Option Name</span>
		...
		<div class="filters-wrap">
			...
			</div><!-- Host Language row -->
		</div><!-- .filters-wrap -->

		<div class="search-filter-footer text-right">
			<button type="submit" class="btn btn btn-grey-outlined">Reset</button>
