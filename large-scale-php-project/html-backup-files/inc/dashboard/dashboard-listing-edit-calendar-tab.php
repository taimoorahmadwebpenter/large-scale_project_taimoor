		...
		<div class="calendar-navigation custom-actions">
			...
			<div class="btn-group">
				<button type="button" class="btn btn-secondary-outlined btn-reserve-period dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Sync iCal <span class="caret"></span>
				</button>
				<ul class="dropdown-menu">
					<li><a href="#" data-toggle="modal" data-target="#modal-calendar-import">Import</a></li>
					<li><a href="#" data-toggle="modal" data-target="#modal-calendar-export">Export</a></li>
				</ul>
			</div>
			...
			<!-- <button class="btn btn-action btn-reserve-period-mobile" data-toggle="modal" data-target="#modal-calendar-import"><i class="homey-icon homey-icon-cloud-upload-internet-networks-servers" aria-hidden="true"></i></button>
			<button class="btn btn-action btn-reserve-period-mobile" data-toggle="modal" data-target="#modal-calendar-export"><i class="homey-icon homey-icon-cloud-download-internet-networks-servers" aria-hidden="true"></i></button>
		...
		<div id="property-calendar" class="property-calendar">
			<div class="homey_month_wrap">
				...
				<ul class="days clearfix">  
					...
					<li class="current-month pending" data-toggle="modal" data-target="#modal-calendar">
...
<?php include ('inc/dashboard/modal-window-calendar-import.php'); ?>
<?php include ('inc/dashboard/modal-window-calendar-export.php'); ?>
