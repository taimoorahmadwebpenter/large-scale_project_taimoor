        ...
        <div class="banner-caption">
            ...
            <div class="mixed-search-panel mixed-search-parallax-banner">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a data-target="#nightly-search-panel" role="tab" data-toggle="tab">Stay</a>
                    </li>
                    <li>
                        <a data-target="#hourly-search-panel" role="tab" data-toggle="tab">Experiences</a>
                    </li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="hourly-search-panel">
                        <?php include ('inc/search/search-for-banners-experiences.php'); ?>
                    </div>
                </div>
            </div>
