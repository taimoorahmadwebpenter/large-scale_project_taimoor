                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="dashboard-area">
                                ...
                                <form method="post" id="add-property-form">
                                    ...
                                    <?php //include 'inc/add-new-listing/dashboard-add-new-listing-step-1.php';?>
                                    <?php //include 'inc/add-new-listing/dashboard-add-new-listing-step-2.php';?>
                                    <?php include 'inc/add-new-listing/dashboard-add-new-listing-step-3.php';?>
                                    <?php // include 'inc/add-new-listing/dashboard-add-new-listing-step-4.php';?>
                                    <?php //include 'inc/add-new-listing/dashboard-add-new-listing-step-5.php';?>
