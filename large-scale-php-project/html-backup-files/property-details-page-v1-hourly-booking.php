...
<body>
    ...
    <section class="detail-property-page-header-area detail-property-page-header-area-v1">
        <div class="property-header-image" style="background-image: url(img/1440x960.png); background-size: cover; background-repeat: no-repeat; background-position: 50% 50%;">

            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <a rel="gallery-1" href="img/big/01.jpg" class="swipebox property-header-gallery-btn">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="content-area">
                        ...
                        <?php include ('inc/property-detail-page/availability-section-hourly.php'); ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <?php include('inc/booking/sidebar-hourly-booking-module.php'); ?>
                </div>
            </div>
        </div>
    </section><!-- main-content-area -->
    <?php include('inc/booking/overlay-hourly-booking-module.php'); ?>
