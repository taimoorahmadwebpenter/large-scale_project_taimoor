...
<body>
    ...
    <section class="main-content-area experiences-listing-page listing-page">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                    <div class="page-title">
                        <div class="block-top-title">
                            ...
                            <h1 class="listing-title">Experiences Listing with Right Sidebar</h1>
                        </div><!-- block-top-title -->
                    </div><!-- page-title -->
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="sidebar right-sidebar">
                        <?php include ('inc/widgets/widget-advanced-search-experiences.php'); ?>
                    </div>
                </div>
            </div><!-- .row -->
        </div>   <!-- .container -->
