                            ...
                            <div class="dashboard-area">
                                <div class="block">
                                    <div class="block-head table-block">
                                        <div class="block-left">
                                            <h2 class="title">Apartment For Rent</h2>
                                ...
                                <div class="homy-taber-module">
                                    <ul class="taber-nav taber-nav-fixed" role="tablist">
                                        ...
                                        <li role="presentation">
                                            <a href="#bedrooms-tab" aria-controls="calendar-tab" role="tab" data-toggle="tab">Bedrooms</a>
                                        </li>
                                        <li role="presentation">
                                ...
                                <div class="block">
                                    ...
                                    <div class="tab-content">
                                        <?php include 'inc/dashboard/dashboard-listing-edit-information-tab.php';?>
                                        <?php include 'inc/dashboard/dashboard-listing-edit-features-tab.php';?>
                                        <?php include 'inc/dashboard/dashboard-listing-edit-location-tab.php';?>
                                        <?php include 'inc/dashboard/dashboard-listing-edit-bedrooms-tab.php';?>
                                        <?php include 'inc/dashboard/dashboard-listing-edit-calendar-tab.php';?>
                                        <?php include 'inc/dashboard/dashboard-listing-edit-media-tab.php';?>
                                        <?php // include 'inc/dashboard/dashboard-listing-edit-meals-tab.php';?>
                                        <?php include 'inc/dashboard/dashboard-listing-edit-pricing-tab.php';?>
                                        <?php include 'inc/dashboard/dashboard-listing-edit-terms-and-rules-tab.php';?>
                                    </div>
                                </div>
                            </div>
                        </div><!-- .dashboard-area -->
