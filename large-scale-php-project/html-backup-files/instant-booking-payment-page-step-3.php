            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-md-pull-5 col-lg-pull-5">
                    ...
                    <div class="block mb-0">
                        ...
                        <div class="block-head table-block">
                            <h2 class="title"><span class="circle-icon">2</span> Rules & Policies <i class="homey-icon check-circle-1 text-success" aria-hidden="true"></i> <a class="edit-booking-form" href="instant-booking-payment-page-step-2.php">Edit</a></h2>
                        </div>
                    </div>
                    ...
                    <div class="block">
                        ...
                        <div class="block-body">
                            ...
                            <div class="continue-block-button">
                                <button type="button" class="btn btn-booking btn-full-width" onclick="window.location.href='dashboard-reservation-confirmed-user.php'">Process Payment</button>
                            </div>
                        </div>
                    </div>
                </div>
