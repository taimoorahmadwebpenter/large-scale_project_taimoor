        ...
        <div class="user-dashboard-right dashboard-with-sidebar">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="dashboard-area">
                                ...
                                <form method="post" id="add-property-form">
                                    ...
                                    <?php include 'inc/add-new-experience/dashboard-add-new-experience-step-1.php';?>
                                    <?php include 'inc/add-new-experience/dashboard-add-new-experience-step-2.php';?>
                                    <?php include 'inc/add-new-experience/dashboard-add-new-experience-step-3.php';?>
                                    <?php include 'inc/add-new-experience/dashboard-add-new-experience-step-4.php';?>
                                    <?php include 'inc/add-new-experience/dashboard-add-new-experience-step-5.php';?>
            ...
            <aside class="dashboard-sidebar">
                <div class="item-grid-view">
                    <?php include 'inc/dashboard/dashboard-sidebar-add-new-experience.php';?>
                </div>
