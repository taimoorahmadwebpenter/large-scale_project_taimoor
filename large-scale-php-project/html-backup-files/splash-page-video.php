...
<body class="splash-page splash-page-image">
    <div class="banner-inner">
        ...
        <div id="video-background" class="video-background splash-video-background" data-vide-bg="mp4: video/ocean, webm: video/ocean, ogv: http://localhost/homey-html/video/ocean, poster: video/ocean" data-vide-options="position: 0% 50%">
        </div>
        ...
        <?php include ('inc/search/overlay-mobile-search.php'); ?>
