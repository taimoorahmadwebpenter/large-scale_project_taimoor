                            ...
                            <div class="dashboard-area">
                                ...
                                <div class="block">
                                    <div class="block-title">
                                        <h2 class="title">Available Balance $3,596.98</h2>
                                    </div>

                                    <div class="block-body">
                                        <div class="form-group">
                                            <p>Note: the minimum amount for a payout is $ 500</p>
                                            <label for="property-title">Payout Amount</label>
                                            <input type="text" name="title" class="form-control" placeholder="Enter the payout amount. Only numbers">
                                        </div>
                                        <button type="submit" class="btn btn-success btn-xs-full-width">Request a Payout</button>
                                    </div>
                                </div>
                            </div>
                        </div><!-- .dashboard-area -->
