    ...
    <section id="body-area">
        ...
        <div class="user-dashboard-right dashboard-with-sidebar">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="dashboard-area">
                                ...
                                <div class="alert alert-info alert-dismissible" role="alert">
                                    ...
                                    So far so good! Host confirmed availability for this reservation. Complete the payment due
                                </div>
                                ...
                                <div class="payment-buttons">
                                    <button class="btn btn-success btn-half-width">Pay now $99.00</button>
            ...
            <aside class="dashboard-sidebar">
                ...
                <button class="btn btn-success btn-full-width" onclick="window.location.href='dashboard-reservation-payment-user.php'">Pay now $99.00</button>
