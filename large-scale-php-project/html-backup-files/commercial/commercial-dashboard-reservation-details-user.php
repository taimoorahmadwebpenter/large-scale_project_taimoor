                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="dashboard-area">
                                ...
                                <div class="block">
                                    <div class="block-head">
                                        <div class="block-left">
                                            <h2 class="title">Reservation #0001 <span class="label label-secondary">Submitted</span></h2>
                                        </div><!-- block-left -->
                                ...
                                <div class="payment-buttons">
                                    <span class="btn btn-success-outlined btn-half-width"><i class="homey-icon homey-icon-check-circle-1"></i> Submitted</span>
