    ...
    <section id="body-area">
        ...
        <div class="user-dashboard-right dashboard-with-sidebar">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="dashboard-area">
                                ...
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    ...
                                    You confirmed availability for this reservation
                                </div>

                                <div class="block">
                                    <div class="block-head">
                                        <div class="block-left">
                                            <h2 class="title">Reservation #0001 <span class="label label-secondary">AVAILABLE</span></h2>
                                        </div><!-- block-left -->
                                    ...
                                    <div class="block-section">
                                        <div class="block-body">
                                            ...
                                            <div class="block-right">
                                                <?php include ('inc/booking/experience-payment-list.php'); ?>
                                            </div><!-- block-right -->
                                        </div><!-- block-body -->
                                    </div><!-- block-section -->
                                </div><!-- .block -->
                                <div class="payment-buttons">
                                    <span class="btn btn-success-outlined btn-half-width"><i class="homey-icon homey-icon-check-circle-1"></i> Available</span>
            ...
            <aside class="dashboard-sidebar">
                <?php include 'inc/dashboard/dashboard-experience-payment-details-block.php';?>
                <span class="btn btn-success-outlined btn-full-width"><i class="homey-icon homey-icon-check-circle-1"></i> Available</span>
