            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="night_price" class="form-control" id="night-price" placeholder="Enter price for 1 day">
                    </div>
                </div>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="priceMonthly" class="form-control" id="priceMonthly" placeholder="Enter price for 1 month">
                    </div>
                </div>
            </div>
            <hr class="row-separator">
    ...
    <div class="block">
        ...
        <div class="block-body">
            ...
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        <label for="min-nights">Minimum Days</label>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        <label for="max-nights">Maximum Days</label>
